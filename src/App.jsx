...
const Q = [
  ...
  ["strategy", 5, "A minigrid operator can vertically integrate into appliance financing. Analyze the strategic trade-offs.", ["Increases ARPU and energy consumption but adds credit risk, working capital requirements, and operational complexity — viable if loss rates are manageable and the appliance-energy bundle creates a defensible moat", "Never worth the risk", "Always beneficial", "Only for large operators"], 0, "Vertical integration into appliance finance creates a consumption-financing flywheel but introduces credit risk management as a core competency requirement."],
  ...
  ["economics", 3, "What is 'willingness to pay' and how do you measure it for off-grid energy customers?", ["The maximum price a consumer will pay for a good — measured through revealed preference (actual spending on alternatives like kerosene, phone charging) and stated preference surveys", "Government-set tariff levels", "The price customers say they'll pay", "The cost of service"], 0, "WTP combines revealed preference (what they currently spend on energy substitutes) and stated preference (contingent valuation surveys) — revealed preference is more reliable."],
  ["economics", 4, "Explain the concept of 'energy poverty trap' and how productive use of electricity can break it.", ["Only grid extension solves energy poverty", "Low energy access limits productive capacity, suppressing income, which limits ability to pay for energy — productive use equipment (mills, welding, refrigeration) creates income that funds energy consumption, breaking the cycle", "Energy poverty is just about price", "Productive use is irrelevant to energy poverty"], 1, "The energy-productivity-income nexus: productive use creates the economic value that makes energy consumption sustainable and drives demand growth."],
  ...
  ["environment", 3, "What is the environmental impact lifecycle of a solar panel?", ["Manufacturing (energy, materials, chemicals), transport, installation, 25+ year clean generation, then end-of-life recycling/disposal of glass, silicon, metals, and trace hazardous materials", "Only during manufacturing", "Only at end of life", "Zero impact"], 0, "Full lifecycle: embodied energy in manufacturing, transport emissions, decades of clean generation, then e-waste management — net positive but not zero impact."],
  ...
  ["literature", 3, "How does the concept of 'ubuntu' in Southern African philosophy relate to Western existentialism?", ["Ubuntu ('I am because we are') grounds identity in communal relationships, contrasting with existentialism's focus on individual existence preceding essence — both address what it means to be human but from communal vs individual starting points", "Ubuntu is a form of existentialism", "They're completely unrelated", "They're identical"], 0, "Ubuntu and existentialism both address human identity but from opposite poles: relational/communal vs. individual/autonomous."],
  ["literature", 4, "Thomas Mofolo's 'Chaka' (1925), written in Sesotho, is significant because:", ["It was written in English first", "It's one of the earliest novels written in an African language, depicting the Zulu king's rise and fall while exploring power, ambition, and moral corruption — themes directly relevant to leadership", "It was the first African novel", "It's a history textbook"], 1, "Mofolo's Chaka is a foundational work of African literature in an indigenous language, exploring the corrupting nature of power — profoundly relevant to any leader."],
  ...
  ["philosophy", 3, "How does John Rawls' 'veil of ignorance' apply to minigrid tariff design?", ["It's about hiding information from regulators", "It doesn't apply to business", "It means tariffs should be equal for everyone", "If you designed tariffs not knowing whether you'd be a wealthy or poor customer, you'd create a structure ensuring basic access is affordable — the veil reveals just pricing principles"], 3, "Rawls' thought experiment: design the tariff structure as if you didn't know which customer you'd be — naturally producing lifeline rates and progressive structures."],
  ["philosophy", 4, "Amartya Sen's 'capabilities approach' reframes energy access how?", ["Energy access isn't the end goal — it's an enabler of human capabilities (health, education, economic participation). The metric should be what energy enables people to do and be, not just kWh delivered", "Capabilities are irrelevant to energy", "Energy as a commodity only", "Energy should be free"], 0, "Sen shifts from 'how much energy' to 'what can people do with energy access' — a more meaningful development framework."],
  ...
  ["emotional_iq", 3, "Two team members have an escalating conflict. One is technically right but interpersonally wrong. How do you mediate?", ["Acknowledge the technical merit separately from the interpersonal dynamic. Address the 'how' (communication, respect) before the 'what' (technical decision) — because the process failure will recur even if this content issue is resolved", "Separate them permanently", "Tell them to work it out themselves", "Side with whoever is technically correct"], 0, "Process before content: if you only fix the technical issue, the interpersonal pattern will generate future conflicts. Fix the communication pattern."],
  ["emotional_iq", 4, "You're presenting to potential investors and one asks a hostile, loaded question clearly designed to test your composure. What is the emotionally intelligent response?", ["Match their energy — be aggressive back", "Pause, acknowledge the question's premise charitably, answer the substance directly, and demonstrate that pressure doesn't compromise your clarity — the meta-message (composure under fire) matters more than the answer content", "Get visibly upset to show passion", "Deflect to a different topic"], 1, "Under hostile questioning, the audience evaluates your composure as a proxy for how you'll handle adversity as a leader. The meta-signal IS the answer."],
  ...
  ["personality", 3, "A major setback occurs (e.g., regulatory rejection of your tariff application). Which response indicates resilient leadership?", ["Immediately pivot to a new country", "Process the disappointment, analyze what happened, identify what's controllable, develop an alternative approach, and re-engage — maintaining long-term commitment while adapting tactics", "Accept defeat and move on", "Blame the regulator publicly"], 1, "Resilience isn't the absence of disappointment — it's the recovery curve. Grieve, learn, adapt, persist."],
  ["personality", 4, "You tend to take on too many things yourself. A coach tells you this is simultaneously your greatest strength and biggest liability. Explain why they're right.", ["Delegation is always the answer", "They're wrong — handling everything is just being thorough", "High agency and broad competence mean you CAN do many things, which creates a trap: doing replaces building. The company's ceiling is your personal bandwidth unless you shift from doing to enabling. The strength (capability) becomes the constraint (bottleneck)", "Only weak leaders delegate"], 2, "The founder's dilemma: the skills that got you here (doing everything) are exactly what will prevent you from getting there (scaling through others)."],
